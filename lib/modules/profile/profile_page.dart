                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: const Text("Sair", style: TextStyle(color: Colors.red, fontSize: 18)),
...
class HeaderClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(
      size.width / 2, // Ponto de controle X (meio da tela)
      size.height,    // Ponto de controle Y (fundo total da área verde)
      size.width,     // Ponto final X
      size.height - 50 // Ponto final Y
    );
    
    path.lineTo(size.width, 0); // Sobe para o topo direito
    path.close();
    return path;
  }
